...
$server_actions = ['sync', 'ingest', 'export', 'delete_rag', 'preview', 'inject_quiz', 'inject_assign', 'inject_forum', 'export_pdf', 'export_pdf_teacher', 'export_docx', 'export_docx_teacher'];
