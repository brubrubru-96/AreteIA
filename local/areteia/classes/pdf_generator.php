...
class pdf_generator {
     ...
     */
    public static function generate_student_pdf(array $items, string $title, string $course_name): string {
        global $CFG;
     ...
     * @return string PDF binary content
     */
    public static function generate_teacher_pdf(array $items, string $title, string $course_name, string $justification, array $objectives_data): string {
        global $CFG;
        require_once($CFG->libdir . '/tcpdf/tcpdf.php');
